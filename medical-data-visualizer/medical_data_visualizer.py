...
def draw_cat_plot():
    ...
    fig = sns.catplot(
        data = df_cat, hue = 'value', x= 'variable',
        kind = 'count',col='cardio').set_axis_labels(
        "variable", "total")
...
def draw_heat_map():
    ...
    sns.heatmap( corr,mask = mask, annot = True ,fmt='.1f',linewidths=1, vmin= -0.08, vmax=0.24, center = 0)
